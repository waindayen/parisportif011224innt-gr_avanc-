    ...
    switch (userData?.role) {
      ...
      case 'apiuser':
        return [
          ...
          { icon: Wifi, label: 'Configuration API', path: '/dashboard/api/odds-config' },
          { icon: BarChart, label: 'Sports & Cotes', path: '/dashboard/api/sports-config' },
          { icon: Sliders, label: 'Paramètres API', path: '/dashboard/api/settings' },
        ];
      case 'externaluser':
        return [
